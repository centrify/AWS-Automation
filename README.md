...
#Deployment process
  ...
  5. If your AWS instance does not need to join to Active Directory, skip to step 6.</br>
...
Replace *your_s3_bucketname* by the name of the S3 bucket that you created in step 2.	   
  ...
  6. Download startup-userdata.sh and create an userdata template.  See the section **Configuration Parameters** for more information.
